...
logging.basicConfig(filename='log.log',
                    format='%(asctime)s:\t[%(name)s]:\t\t%(module)s\t%(thread)d\t%(threadName)s\t%(levelname)s\t'
                           '%(lineno)d:\t%(message)s',
                    level=logging.DEBUG)
logging.info('BasicConfiguration of logging done...')
form = logging.Formatter('%(asctime)s:\t[%(name)s]:\t\t%(module)s\t%(thread)d\t%(threadName)s\t%(levelname)s\t'
                         '%(lineno)d:\t%(message)s')
logging.info('Formatter form was created...')
form_debug = logging.Formatter('%(asctime)s:\t[%(name)s]:\t%(module)s\t%(thread)d\t%(threadName)s\t%(levelname)s\t'
                               '%(lineno)d:\t%(message)s')
